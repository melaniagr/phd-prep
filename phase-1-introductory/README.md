...
|--------|-------------|------|-------|
| Digital Health Specialization | Imperial College London | 2025 | Design, implement, evaluate |
| Global Health Innovation (3 parts) | Imperial College London | 2023 | Principles, entrepreneurship, success |
| Data Ethics, AI & Responsible Innovation | University of Edinburgh | 2025 | Ethical AI deployment |
| Frugal Innovation (2 parts) | GASOC | 2025 | Systems thinking |
| Innovation in Healthcare | University of Bath | 2023 | Systems improvement |
| Health Technology Assessment (3 parts) | University of Glasgow | 2025 | HTA methodology |
| Project Management Foundations | Google | 2025 | Systems delivery |

### research + QI stream 🟢
| Course | Institution | Year | Focus |
|--------|-------------|------|-------|
| Public Involvement in Research | Imperial College London | 2025 | Patient engagement |
| Good Clinical Practice | NIHR | 2025 | Research ethics |
| Research & Audit | NHS HEE | 2024 | Methodological rigor |
| BMJ QI: Foundations of Change | BMJ Learning | 2022 | QI frameworks |
| BMJ QI: Clinical Leadership | BMJ Learning | 2022 | Leadership |
| BMJ QI: Model for Improvement | BMJ Learning | 2022 | Measurement |
...
**clinical systems foundation**:
- understand how innovation actually translates to healthcare
- systems thinking (not just individual molecules/algorithms)
- evidence-based decision making (HTA, QI frameworks)

**bridge to computational cognitive science**:
- RL models must improve patient outcomes
- understanding implementation barriers (clinical reality)
- quality metrics for real-world deployment
